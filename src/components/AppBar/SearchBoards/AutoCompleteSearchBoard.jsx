...
/**
 * Hướng dẫn Autocomplele của MUI
...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally(() => {
        // lưu ý setloading về false ở đây để tránh trường hợp gọi API không thành công thì vẫn sẽ Loading
        setLoading(false)
      })
  }
  // Làm useDebounceFn...
  ...
  return (
    <Autocomplete
      ...
      noOptionsText={!boards ? 'Gõ vào bảng tìm kiếm...' : 'Không tìm thấy bảng!'}

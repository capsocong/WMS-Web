export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TienDev MERN Stack Board',
    description: 'This is a board for TienDev MERN Stack Course',
    type: 'public', // 'private'
    ownerIds: [], // Những users là Admin của board
    memberIds: [], // Những users là member bình thường của board
    columnOrderIds: ['column-id-02', 'column-id-01', 'column-id-03', 'column-id-04-placeholder-card'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        title: 'To Do Column 01',
        cardOrderIds: ['card-id-01', 'card-id-03', 'card-id-04', 'card-id-02', 'card-id-05', 'card-id-06', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
      ...
      },
      {
        ...
        cardOrderIds: [],
        cards: [
          { _id: 'column-id-04-placeholder-card-id-04',
            boardId: 'board-id-01',
